            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg shadow-sm">
                  ...
                  <p className="text-sm text-blue-600 dark:text-blue-400">Order Received</p>
                </div>
                <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg shadow-sm">
                  ...
                  <p className="font-semibold text-yellow-700 dark:text-yellow-300">Preparing</p>
                  <p className="text-sm text-yellow-600 dark:text-yellow-400">Next Step</p>
                </div>
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg shadow-sm">
                  <CheckCircle className="h-8 w-8 text-green-600 dark:text-green-400 mx-auto mb-2" />
                  <p className="font-semibold text-green-700 dark:text-green-300">Delivered</p>
                  <p className="text-sm text-green-600 dark:text-green-400">Final Step</p>
                </div>
              </div>
